...
- **Trois langues, trois usages** — le **nom du jeu et le code** sont en anglais : le premier pour la portée internationale, le second par règle d'exécution. L'**interface et le contenu de la 0.x sont en français** : la preuve de concept s'adresse à l'opérateur, traduire à ce stade serait du travail perdu. Une portée internationale reste visée : l'interface ne doit donc jamais figer la langue dans le code, et les **termes importants sont fixés en anglais et en français dès leur création** ([glossaire](../glossaire.md)), pour qu'aucune traduction ne se décide après coup. La conception reste rédigée en français. Écarté : un nom sur base française ; une interface anglaise dès la preuve de concept (coût sans bénéfice).
