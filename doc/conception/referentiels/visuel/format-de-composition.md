...
- **Aucune créature ni aucun humain ne se décrit librement dans une consigne** : chaque habitant cite sa fiche — [créatures témoins](../contenu/creatures-temoins.md), [personnages](inventaire/personnages.md) — mot pour mot. Une scène qui a besoin d'une espèce ou d'un personnage nouveau commence par sa fiche.
...
- **Un arbre peut faire plusieurs cases** — décision de l'opérateur : les arbres ne sont pas limités à une case au sol ; un grand arbre déclare son emprise multi-cases comme un bâtiment, en plus de sa projection de houppier.
